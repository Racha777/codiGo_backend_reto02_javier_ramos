...
def biografia():
    if('token' in session):
        biografiaData=fb.getDocument('biografia','pPLAK1mFz4t7aR90uadg')
        ...
        if biografia_form.validate_on_submit():
            ...
            resultadoUpdateBiografia=fb.updateDocument('biografia','pPLAK1mFz4t7aR90uadg',dataBiografiaActualizada)
